...
const images = [
  {
    src: "/unatecido.webp",
    alt: "Slide 1",
    text: "Tecido premium com toque macio.",
  },
  {
    src: "/slide-2.png",
    alt: "Slide 2",
    text: "Ajustes para o encosto e assento.",
  },
  {
    src: "/slide-3.png",
    alt: "Slide 3",
    ...
    <section className="px-6 py-20 bg-gray-100 text-center">
      ...
      <div className="hidden md:block relative w-full">
        <div className="flex items-center justify-center relative">
          ...
          <button
            onClick={prev}
            className="absolute left-[calc(50%-500px)] top-1/2 -translate-y-1/2 z-10 bg-white text-gray-800 shadow-md rounded-full px-3 py-2 hover:bg-gray-200 transition"
          >
            ◀
          </button>
          ...
          <button
            onClick={next}
            className="absolute right-[calc(50%-500px)] top-1/2 -translate-y-1/2 z-10 bg-white text-gray-800 shadow-md rounded-full px-3 py-2 hover:bg-gray-200 transition"
          >
            ▶
          </button>
        </div>
